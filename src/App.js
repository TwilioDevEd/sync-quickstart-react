          ...
          <div className="container">
            ...
            <div className="card border-primary">
              <div className="card-body text-info">
                ...
                <h6 className="card-subtitle mb-2 text-muted">Provide a unique identity for each user joining the cobrowsing session</h6>
                <div className="input-group mb-3">
                  <input type="text" placeholder="Identity (username)"
                defaultValue={this.state.identity}
                onChange={e => this.setIdentity(e)}></input>
